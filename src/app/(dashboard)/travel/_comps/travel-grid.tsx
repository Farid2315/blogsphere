...
const travels = [
  {
    ...
    name: "Travel Name",
    location: "Location",
    image: "/modern-travel-interior.png",
  ...
  },
  {
    ...
    name: "Travel Name",
    location: "Location",
    image: "/elegant-travel-dining.png",
    offer: "offer type like 50% or by 1 get 1 or launch offer etc..T&C",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: "Travel Name",
    location: "Location",
    image: "/trendy-travel-interior.png",
    offer: "offer type like 50% or by 1 get 1 or launch offer etc..T&C",
  },
]
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex justify-between items-start mb-2">
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-foreground text-sm sm:text-base truncate">{travel.name}</h3>
                    <p className="text-xs sm:text-sm text-muted-foreground truncate">{travel.location}</p>
                  </div>
                ...
                <div className="mb-3 sm:mb-4">
                  ...
                  <p className="text-xs text-muted-foreground line-clamp-2">{travel.offer}</p>
                </div>
