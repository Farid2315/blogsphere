...
export async function GET(request: NextRequest) {
  try {
    ...
    if (latitude && longitude) {
      ...
      // Filter travels by approximate distance using bounding box
      ...
      // Use aggregation to get all travels and calculate distance
      const nearbyTravels = await prisma.post.aggregateRaw({
        pipeline: [
          {
            $match: {
              domain: { $in: ["travel", "style"] }
            }
          },
      ...
      // Get total count for all travels
